...
public class ForNameAgent extends ClassLoader {
	...
	static {
		try {
			...
			clazz = Class.forName("spec.benchmarks.scimark.sor.Main");
			clazz = Class.forName("spec.benchmarks.scimark.sor.SOR");
			clazz = Class.forName("spec.benchmarks.scimark.sor.SOR$1");
